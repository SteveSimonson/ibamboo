...
export const HEROES: Record<Category, CategoryHeroContent> = {
  kitchen: {
    ...
    image: '/brand/categories/kitchen.webp',
  ...
  'cutting-boards': {
    ...
    image: '/brand/categories/cutting-boards.webp',
  ...
  dining: {
    ...
    image: '/brand/categories/dining.webp',
    objectPosition: 'center 45%',
  ...
  bath: {
    ...
    image: '/brand/categories/bath.webp',
  ...
  organization: {
    ...
    image: '/brand/categories/organization.webp',
    objectPosition: 'center 40%',
  ...
  desk: {
    ...
    image: '/brand/categories/desk.webp',
    objectPosition: 'center 40%',
  ...
  outdoor: {
    ...
    image: '/brand/categories/outdoor.webp',
    objectPosition: 'center 45%',
  ...
  baby: {
    ...
    image: '/brand/categories/baby.webp',
    objectPosition: 'center 45%',
